...
const fetchUser = async () => {
  try {
    setLoading(true)
    const res = await axios.get(`${apiUrl}/accounts/user`, { withCredentials: true });
...
const logoutUser = async () => {
  try {
    ...
    await axios.post(`${apiUrl}/accounts/logout`, {}, { withCredentials: true });
  } catch (err) {
  ...
  const logout = async () => {
    try {
      ...
      console.log("Logged out successfully, data will be refetched immediately.");
    } catch (err) {
